...
export const MuiThemeOptions = (mode: PaletteMode): ThemeOptions => {
  return {
    ...
    typography: {
      fontFamily: ["Poppins"].join("Roboto"),
      fontSize: 16,
      h1: {
        fontSize: "80px",
        lineHeight: "0.8em",
      ...
      MuiCard: {
        styleOverrides: {
          root: ({ ownerState, theme }) => {
            return {
              borderRadius: "8px",
              boxShadow: `0px 4px 24px 0px ${primaryColors.border_primary}`
            };
          }
        }
      },
        ...
        styleOverrides: {
          root: ({ ownerState, theme }) => {
            ...
            if (
              ...
              return {
                backgroundColor: primaryColors?.borderprimary,
            ...
            if (
              ...
              return {
                ...
                "&:hover": {
                  background: primaryColors?.dangerColor,
            ...
            if (
              ...
              return {
                backgroundColor: primaryColors?.success_color,
                color: primaryColors?.black,
                "&:hover": {
                  backgroundColor: primaryColors?.success_color,
